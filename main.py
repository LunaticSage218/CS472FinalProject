# pxrf unsupervised pipeline: autoencoder + hdbscan + classification
import argparse
import json
import numpy as np
import pandas as pd
...
def run_pipeline(csv_path, out_dir='results', latent_dim=8, epochs=100, batch_size=32, run_baselines=True, use_pca_for_viz=True, test_size=0.2):
    ensure_dir(out_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', type=str, default='results', help='output directory for results and figures')
